...
import com.mymagiccard.adapters.xml.mapper.EditionXmlvMapper;
import com.mymagiccard.adapters.xml.mapper.CarteXmlvMapper;
import com.mymagiccard.adapters.xml.xmlv.CartesXmlV;
import com.mymagiccard.adapters.xml.xmlv.EditionsXmlV;
import com.mymagiccard.domain.ports.api.InsertionsApiPort;
...
public class InsertionsApiController implements InsertionsApiPort {
    ...
    @ApiOperation("Insertion des noms des cartes")
    @PostMapping(path = "/postNames")
    @Override
    public void postNomsCartesToDb() {
        service.postNamesToDb();
    }
}
